...
#Region "Required Function"
	...
	'---------- LIST ----------'
	Shared Function List(Optional ByVal Query As String = "", Optional ByVal Condition As String = "", Optional ByVal SortOrder As String = "part_id", Optional SQLConn As MySqlConnection = Nothing) As ListItem
